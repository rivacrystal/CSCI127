...
#This program allows a player to go through a maze
    ...
    for command in commands:
        ...
        if command == 'R':
            if isPositionAvailable(row, col+1, maze):
                col += 1
                print("moved Right, current position is:", row, col)
                if maze[row][col] == "X":
                    return True
            else:
        ...
        if command == 'L':
            if isPositionAvailable(row, col-1, maze):
                col -= 1
                print("moved Left, current position is:", row, col)
                if maze[row][col] == "X":
                    return True
            else:
        ...
        if command == 'U':
            if isPositionAvailable(row-1, col, maze):
                row -= 1
                print("moved Up, current position is:", row, col)
                if maze[row][col] == "X":
                    return True
            else:
        ...
        if command == 'D':
            if isPositionAvailable(row+1, col, maze):
                row += 1
                print("moved Down, current position is:", row, col)
                if maze[row][col] == "X":
                    return True
            else:
